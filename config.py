"""Central, environment-backed configuration for SupportGPT."""
...
RAG_TOP_K: int = 5
GEMINI_ERROR_MESSAGE: str = "I couldn't reach the support assistant just now. Please try again in a moment."
SYSTEM_PROMPT: str = """You are SupportGPT, an AI customer support assistant.
...
- When reference context is provided, use it as the source of truth. If it
  does not answer the question, say so instead of inventing an answer.
